# -------------------------------------------------------------
# GOLD: Filtra plano_acao_meta_acao pelos IDs de plano_acao_meta.
# -------------------------------------------------------------
...
# -------------------------------------------------------------
# Tabela base  
PLANO_ACAO_ANALISE_TABLE = "gold.transferegov.plano_acao_meta"
COLUNA_BASE_JOIN = "id_meta_plano_acao"

# Endpoint relacionado 
ENDPOINT_RELACIONADO = "plano_acao_meta_acao"
COLUNA_RELATED_JOIN = "id_meta_plano_acao"
