# -------------------------------------------------------------
# GOLD: Filtra plano_acao_analise_responsavel pelos IDs de plano_acao_analise.
# -------------------------------------------------------------
...
# -------------------------------------------------------------
# Tabela base  
PLANO_ACAO_ANALISE_TABLE = "gold.transferegov.plano_acao_analise"
COLUNA_BASE_JOIN = "id_analise_plano_acao"

# Endpoint relacionado 
ENDPOINT_RELACIONADO = "plano_acao_analise_responsavel"
COLUNA_RELATED_JOIN = "plano_acao_analise_fk"
